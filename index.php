...
<html>
  <head>
    ...
    <title>My-Page mypage.com</title>
      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="sidenav-header d-flex align-items-center justify-content-center">
          ...
          <div class="sidenav-header-inner text-center"><img src="img/avatar-1.jpg" alt="person" class="img-fluid rounded-circle">
            <a href="profile.html"><h2 class="h5">Anderson Hardy</h2></a>
          </div>
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            ...
            <li><a href="charts.html"> <i class="fa fa-bar-chart"></i>Market place</a></li>
            <li><a href="tables.html"> <i class="icon-grid"></i>Upload</a></li>
            <li><a href="tables.html"> <i class="icon-grid"></i>Setting</a></li>
            ...
            <li><a href="login.html"> <i class="icon-interface-windows"></i>Log Out</a></li>
        </div>
      </div>
    </nav>
    <div class="page">
          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              <div class="navbar-header"><a id="toggle-btn" href="#" class="menu-btn"><i class="icon-bars"> </i></a><a href="index.html" class="navbar-brand">
                  <div class="brand-text d-none d-md-inline-block"><strong class="text-primary">Company-Name</strong></div></a></div>
